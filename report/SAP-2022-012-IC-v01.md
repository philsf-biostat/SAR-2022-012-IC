...
Todas as mensurações foram realizadas por 5 avaliadores independentes.
As medidas de rotação e translação lateral da fíbula serão avaliadas nesta análise, conforme decrito na seção 5.1.
...
As mensurações referentes às medidas de rotação e translação lateral da fíbula (seção 4)
serão descritas como
média (DP).
